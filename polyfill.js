...
if (!('resize' in document.createElement('div'))) {
  /** @typedef {import('./polyfill').ResizableElementMode} ResizableElementMode */
  /** @typedef {import('./polyfill').ResizeConfigItem} ResizeConfigItem */
  /** @typedef {import('./polyfill').ResizedInfo} ResizedInfo */
